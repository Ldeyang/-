			...
			<form action="${pageContext.request.contextPath}/saveBook"
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="bHouse"
								placeholder="出版社" value="">
						</div>
						...
						<div class="col-md-4 data">
							<select class="form-control select2" style="width: 100%"
								name="bBorrow">
								<option value="0" selected="selected">可借阅</option>
								<option value="1">被借阅</option>
							</select>
						</div>
						<div class="col-md-2 title">存储位置</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="weiZhi"
								   placeholder="存储位置" value="">
						</div>
					</div>
				</div>
				<!--订单信息/--> <!--工具栏-->
