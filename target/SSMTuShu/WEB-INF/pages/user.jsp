				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" disabled=disabled class="form-control" name="id"
								   placeholder="ID" value="${user.id}">
						</div>
						<div class="col-md-2 title">学号</div>
						<div class="col-md-4 data">
							<input type="text" disabled=disabled class="form-control" name="xId"
								placeholder="学号" value="${user.xId}">
						</div>
						<div class="col-md-2 title">联系电话</div>
						<div class="col-md-4 data">
							<input type="text" disabled=disabled class="form-control" name="phone"
